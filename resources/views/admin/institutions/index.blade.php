      ...
      <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('admin.institutions.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Cadastrar Instituição</a>
            </div>
          <div class="card-body">
              ...
              <tbody>
                @foreach ($institutions as $institution)
                    <tr>
                        ...
                        <td class="">
                            <a href="{{ route('admin.institutions.edit', $institution->id) }}" class="btn btn-primary btn-sm"> <i class="fa fa-pen"></i> </a>
